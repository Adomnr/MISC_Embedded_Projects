...
HD_PWD='D:/AKSA-SDS/Task 3 Verilog/fourtofivebitmultiplier/fourtofivebitmultiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arrayMultiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arrayMultiplier.tcl
