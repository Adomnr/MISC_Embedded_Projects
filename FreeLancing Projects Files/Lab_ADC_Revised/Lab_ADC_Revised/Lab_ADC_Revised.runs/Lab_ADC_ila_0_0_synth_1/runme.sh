...
HD_PWD='D:/Extra_Projects/Lab_ADC_Revised/Lab_ADC_Revised/Lab_ADC_Revised.runs/Lab_ADC_ila_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_ADC_ila_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab_ADC_ila_0_0.tcl
