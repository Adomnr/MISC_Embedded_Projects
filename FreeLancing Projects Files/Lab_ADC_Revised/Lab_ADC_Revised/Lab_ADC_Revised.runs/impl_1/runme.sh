...
HD_PWD='D:/Extra_Projects/Lab_ADC_Revised/Lab_ADC_Revised/Lab_ADC_Revised.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_ADC_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab_ADC_wrapper.tcl -notrace
