...
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ Lab_ADC_ADC_FSM_0_0_sim_netlist.vhdl
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ADC_FSM is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ADC_FSM;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ADC_FSM is
  ...
  signal bit_counter_1 : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute SOFT_HLUTNM of \bit_counter[1]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \bit_counter[2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of chip_select_out_i_3 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \tri_state_counter[0]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \tri_state_counter[1]_i_1\ : label is "soft_lutpair0";
begin
  chip_select_out <= \^chip_select_out\;
  ready_out <= \^ready_out\;
\FSM_sequential_state[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"000F000FFF880088"
    )
        port map (
      I0 => start_in,
      I1 => ready_in,
...
\address_bram[0]_i_3\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
chip_select_out_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
chip_select_out_i_4: unisim.vcomponents.LUT6
    generic map(
...
\sample_out[11]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0040"
    )
        port map (
...
\sample_out[11]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "Lab_ADC_ADC_FSM_0_0,ADC_FSM,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "ADC_FSM,Vivado 2019.1";
...
begin
U0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ADC_FSM
     port map (
