...
set_property PACKAGE_PIN J2 [get_ports chip_select_out]					
	set_property IOSTANDARD LVCMOS33 [get_ports chip_select_out]
##Sch name = JA4
...
set_property PACKAGE_PIN H1 [get_ports ready_out_1]					
	set_property IOSTANDARD LVCMOS33 [get_ports ready_out_1]
##Sch name = JA8
#set_property PACKAGE_PIN K2 [get_ports data_out]					
