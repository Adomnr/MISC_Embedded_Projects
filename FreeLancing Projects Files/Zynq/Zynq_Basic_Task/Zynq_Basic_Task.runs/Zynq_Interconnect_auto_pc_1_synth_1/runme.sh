...
HD_PWD='D:/Extra_Projects/Zynq/Zynq_Basic_Task/Zynq_Basic_Task.runs/Zynq_Interconnect_auto_pc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Zynq_Interconnect_auto_pc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Zynq_Interconnect_auto_pc_1.tcl
