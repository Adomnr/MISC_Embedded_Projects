...
HD_PWD='D:/Extra_Projects/Zynq/Zynq_Basic_Task/Zynq_Basic_Task.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Zynq_Interconnect_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Zynq_Interconnect_wrapper.tcl -notrace
