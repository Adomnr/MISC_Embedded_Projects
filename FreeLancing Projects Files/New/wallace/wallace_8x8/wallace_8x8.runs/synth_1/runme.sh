...
HD_PWD='D:/Extra_Projects/New/wallace/wallace_8x8/wallace_8x8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wallace_8x8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wallace_8x8.tcl
