...
HD_PWD='D:/Extra_Projects/Testing/Testing/Testing.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IMAGEProcess.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IMAGEProcess.tcl
