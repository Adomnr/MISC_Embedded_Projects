...
HD_PWD='D:/Extra_Projects/8x1Mux/8x1Mux/8x1Mux.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux_8x1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mux_8x1.tcl
