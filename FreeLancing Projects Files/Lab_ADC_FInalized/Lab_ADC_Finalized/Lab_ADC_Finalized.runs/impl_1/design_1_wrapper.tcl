...
set rc [catch {
  ...
  add_files -quiet D:/Extra_Projects/Lab_ADC_FInalized/Lab_ADC_Finalized/Lab_ADC_Finalized.runs/synth_1/design_1_wrapper.dcp
  ...
  set_param project.isImplRun true
  link_design -top design_1_wrapper -part xc7a100tftg256-1
  set_param project.isImplRun false
