...
set rc [catch {
  ...
  add_files -quiet D:/file/Updated/Files_Projects/Extra_Projects/basys3uart/basysuart/basysuart.runs/synth_2/top.dcp
...
set rc [catch {
  ...
  create_report "impl_2_place_report_control_sets_0" "report_control_sets -verbose -file top_control_sets_placed.rpt"
...
set rc [catch {
  ...
  create_report "impl_2_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file top_timing_summary_routed.rpt -pb top_timing_summary_routed.pb -rpx top_timing_summary_routed.rpx -warn_on_violation "
  ...
  create_report "impl_2_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file top_bus_skew_routed.rpt -pb top_bus_skew_routed.pb -rpx top_bus_skew_routed.rpx"
