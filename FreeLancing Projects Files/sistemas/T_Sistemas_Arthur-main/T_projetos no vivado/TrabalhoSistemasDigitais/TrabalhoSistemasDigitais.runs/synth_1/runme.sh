...
HD_PWD='C:/Users/joaoc/OneDrive/Desktop/Faculdade/Sistemas Digitais/TrabalhoSistemasDigitais/TrabalhoSistemasDigitais.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ParteControle.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ParteControle.tcl
