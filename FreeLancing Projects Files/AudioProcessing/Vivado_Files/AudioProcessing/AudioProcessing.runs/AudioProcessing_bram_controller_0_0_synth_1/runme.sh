...
EAStep vivado -log AudioProcessing_bram_controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AudioProcessing_bram_controller_0_0.tcl
