...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net blk_mem_gen_0_douta [get_bd_ports data_out] [get_bd_pins blk_mem_gen_0/douta] [get_bd_pins bram_controller_0/data_in]
  ...
  connect_bd_net -net clock_1 [get_bd_ports clock] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins bram_controller_0/clk]
