...
HD_PWD='D:/Extra_Projects/ADC_RX/ADC_RX/ADC_RX.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADC_RX_Test_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADC_RX_Test_wrapper.tcl
