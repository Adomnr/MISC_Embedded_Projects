...
HD_PWD='D:/Extra_Projects/ADC_RX/ADC_RX/ADC_RX.runs/ADC_RX_Test_uart_adc_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADC_RX_Test_uart_adc_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADC_RX_Test_uart_adc_0_0.tcl
