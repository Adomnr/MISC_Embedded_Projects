...
HD_PWD='D:/Extra_Projects/RVM/rvm/rvm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RVM_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RVM_wrapper.tcl
