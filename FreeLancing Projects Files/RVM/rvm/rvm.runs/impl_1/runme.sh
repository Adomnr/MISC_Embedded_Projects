...
HD_PWD='D:/Extra_Projects/RVM/rvm/rvm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RVM_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RVM_wrapper.tcl -notrace
