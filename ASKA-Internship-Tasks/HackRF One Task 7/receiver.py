...
class receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.channel_freq = channel_freq = 99.6e6
        self.center_freq = center_freq = 102e6
        ...
        self._channel_freq_range = qtgui.Range(90e6, 110e6, 100, 99.6e6, 200)
        ...
        self._audio_gain_range = qtgui.Range(0, 10, 1, 1, 200)
