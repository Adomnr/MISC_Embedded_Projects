...
class AM_TRX(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "AM_TRX", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("AM_TRX")
        ...
        self.settings = Qt.QSettings("GNU Radio", "AM_TRX")
        ...
        self._volume_range = qtgui.Range(0, 10, 0.1, 1.2, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 48000, (500e-3), 0, 0)
...
def main(top_block_cls=AM_TRX, options=None):
