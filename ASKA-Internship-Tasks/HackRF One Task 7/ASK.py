...
class ASK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.sps = sps = 100
        self.signal_freq = signal_freq = 20e3
        ...
        self._tx_gain_range = qtgui.Range(0, 47, 1, 10, 200)
        ...
        self._signal_freq_range = qtgui.Range(-100e3, 100e3, 1, 20e3, 200)
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_c((0,1,0,1,0,0,0,1,1,1), True, 1, [])
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, signal_freq, 1, 0, 0)
        ...
        self.connect((self.blocks_threshold_ff_0, 0), (self.qtgui_time_sink_x_0_0_0_0_0, 0))
        ...
        self.connect((self.rtlsdr_source_0, 0), (self.qtgui_time_sink_x_0_0_0, 0))
