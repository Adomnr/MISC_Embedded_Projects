...
class repeater(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "repeater")
        ...
        self.connect((self.blocks_repeat_0, 0), (self.qtgui_freq_sink_x_0, 0))
...
def main(top_block_cls=repeater, options=None):
